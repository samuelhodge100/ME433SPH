...
# def bitmap_threshold(A, R_thresh, G_thresh, B_thresh):
    # A is the bitmap array

def COM(A,row):
    # Function performs a center of mass calculation on a black and white array from a row of the color map
    num = 0
    den = 0

    for i in range(1,60+1):
        # A should be an array of black and white pixels
        num += A[row,i-1]*i
        den += A[row,i-1]
